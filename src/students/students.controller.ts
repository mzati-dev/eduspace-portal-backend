...
// // //   /**
// // //    * Route: GET /students/results/:examNumber
// // //    * This is called when the user enters their Exam Number in the Result Portal
// // //    */
// // //   @Get('results/:examNumber')
// // //   async getResults(@Param('examNumber') examNumber: string) {
// // //     try {
// // //       const result = await this.studentsService.findByExamNumber(examNumber);
// // //       return result;
// // //     } catch (error) {
// // //       // If the service throws a NotFoundException, this ensures the frontend
// // //       // receives a proper 404 error response
...
// // // //   @Get('results/:examNumber')
// // // //   async getResults(@Param('examNumber') examNumber: string) {
// // // //     // Call findByExamNumber to match your Postgres service logic
// // // //     return await this.studentsService.findByExamNumber(examNumber);
// // // //   }
// // // // }