...
export class AuthService {
    ...
    async validateUser(email: string, password: string, schoolId?: string): Promise<any> {
        ...
        if (user) {
            ...
            if (schoolId && user.schoolId !== schoolId) {
                throw new UnauthorizedException('You are not authorized to login from this school portal');
            }
 ...
 async validateParent(phone: string, password: string, schoolId?: string): Promise<any> {
...
if (schoolId && student.schoolId !== schoolId) {
 ...
 async validateTeacher(email: string, password: string, schoolId?: string): Promise<any> {
        ...
        if (schoolId && teacher.school_id !== schoolId) {
    throw new UnauthorizedException('You are not authorized to login from this school portal');
}
